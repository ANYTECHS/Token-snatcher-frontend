...
export const TOKEN_TYPES = ['blue', 'gold', 'red', 'penalty'] as const;
...
export const TOKEN_CONFIG: Record<TokenType, { points: number; color: number; spawnWeight: number; lifetimeMs: number }> = {
  ...
  // Penalty tokens reduce score when clicked. GameScene also renders them distinctly.
  penalty: { points: -15, color: 0xa855f7, spawnWeight: 20, lifetimeMs: 1200 },
};
